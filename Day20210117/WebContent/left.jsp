...
<head>
    ...
    <script type="text/javascript" src="http://code.jquery.com/jquery-1.8.3.min.js"></script>
       ...
       <style type="text/css">
        ...
        #wrap {width: 100%; height: 100px; background-color: white;} 
        header {width: 100%; height: 300px;}
        aside {float: left; width: 20%; height: 700px; background:white; }
       ...
       footer {width: 100%; height: 150px; background-color: #FAFAFA}
        ...
        .header .header_menu {width: 90%; text-align: right; font-weight: bold;right: 10%}
 ...
 $(document).ready(function(){
       ...
       <header id="header">
        ...
        <li class="collapsible">
            ...
            <li><a href="#">오시는길</a></li> 
            <li><a href="index.jsp">테스트용</a></li>           
            </ul>
        </li>
        <li class="collapsible">
            <h2 class="title1"><a href="#">학생마당</a></h2>
            <ul class="content">
         <li><a href="left.jsp?page=bbs">방과후교실</a></li>
         <li><a href="#">시험자료</a></li>
         </ul>
             </li>
        <li class="collapsible">
            ...
            <ul class="content">
         <li><a href="left.jsp?page=bbs">민원신청</a></li>
         <li><a href="#">학부모회</a></li>
         </ul>
        </li>
        <li class="collapsible">
            ...
            <ul class="content">
         <li><a href="left.jsp?page=bbs">연구자료</a></li>
        ...
        <li class="collapsible">
            ...
            <ul class="content">
         <li><a href="left.jsp?page=bbs">공지사항</a></li>
