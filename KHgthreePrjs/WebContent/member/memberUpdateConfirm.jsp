...
out.print("아이디:"+memberDTO.getId()+"패스워드:"+memberDTO.getPw()+"이름:"+memberDTO.getName()+"<br>주소:"+memberDTO.getAddr()+"전화번호:"+memberDTO.getTel()+"직업:"+memberDTO.getStype()+"<p>");
%>
...
<li><input type="submit" value="수정" class="submit">
</li>
</ul>
</form>
</div>
