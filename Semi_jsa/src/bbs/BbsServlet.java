	          ...
	          if(userID == null){
	            ...
	            script.println("alert('로그인을 해주세요.')");
	             ...
	             if (request.getParameter("bbsContent").isEmpty()||request.getParameter("bbsTitle").isEmpty()||request.getParameter("bbsContent").equals("")||request.getParameter("bbsContent").equals("")){
	                ...
	                int bbsID = BbsDAO.write(request.getParameter("bbsTitle"), userID, request.getParameter("bbsContent"),Integer.parseInt(request.getParameter("boardID")),file_id,file_name);
	                if (bbsID == -1){
	                   script.println("<script>");
